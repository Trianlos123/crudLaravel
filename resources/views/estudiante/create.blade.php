                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="table-container">
                            <form method="POST" action="{{ route('estudiante.store') }}"  role="form">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <input type="text" name="nombre" id="nombre" class="form-control input-sm" placeholder="Nombre del estudiante">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">-->
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        ...
                                        <a href="{{ route('estudiante.index') }}" class="btn btn-info btn-block" >Atrás</a>
                                    </div>
